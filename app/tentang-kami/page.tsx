          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-foreground mb-6 tracking-tight leading-tight">
                Membangun Negeri dengan <span className="text-primary">Alat Berat Terpercaya.</span>
              </h1>
              <div className="w-20 h-1.5 bg-primary text-primary-foreground mb-8 rounded-full"></div>
            ...
            <div className="w-full lg:w-1/2 relative group">
              {/* Decorative accent */}
              <div className="absolute -inset-4 bg-muted rounded-[2.5rem] transform rotate-3 group-hover:rotate-6 transition-transform duration-500"></div>
              
              {/* Main Photo Container */}
              <div className="relative aspect-[4/3] rounded-[2rem] overflow-hidden bg-slate-200 border border-border shadow-xl group-hover:shadow-2xl transition-shadow duration-500 flex items-center justify-center">
                 {/* 
                 ...
                 */}
                 ...
                 {/* Floating Badge */}
                 <div className="absolute bottom-6 left-6 right-6 md:right-auto bg-white/95 backdrop-blur-sm p-4 rounded-xl shadow-lg border border-border flex items-center gap-4">
